               ...
               <div class="main-menu-wrapper">
                   ...
                   <ul class="main-nav">
                       ...
                       <li class="has-submenu">
                           ...
                           <ul class="submenu">
                               <li><router-link to=""  @click.native="dashboard(1)" >Admin</router-link></li>
                               <li><router-link to="" @click.native="dashboard(2)">Pharmacy Admin</router-link></li>
                           </ul>
                       </li>
                       <li class="login-link">
...
export default {
   ...
   computed: {
       ...
       homeMenu() {
           return this.$route.name == 'index' || this.$route.name == 'index-1' || this.$route.name == 'index-page' ||  this.$route.name == 'index-2' ||  this.$route.name == 'index-3' ||  this.$route.name == 'index-4';
       },
       doctorMenu() {
          return this.$route.name == 'doctor-index' || this.$route.name == 'doctor-appointments' || this.$route.name == 'schedule-timings' ||  this.$route.name == 'my-patients' ||  this.$route.name == 'messages' ||  this.$route.name == 'invoices' ||  this.$route.name == 'profile-settings' ||  this.$route.name == 'doctor-reviews' ||  this.$route.name == 'doctor-register' ||  this.$route.name == 'doctor-blogs' ||  this.$route.name == 'blog-details' ||  this.$route.name == 'add-blog' ||  this.$route.name == 'edit-blog' ||  this.$route.name == 'add-prescription' ||  this.$route.name == 'edit-prescription' ||  this.$route.name == 'add-billing' ||  this.$route.name == 'edit-billing';
       },
       patientsMenu() {
