					...
					<ul class="main-nav">
						<li class="has-submenu" :class="homeMenu ? 'active' : 'notactive'">
							<a href="#">Home <i class="fas fa-chevron-down"></i></a>
								<ul class="submenu">
									...
									<li :class="currentPath == 'index-3' ? 'active' : 'notactive'"><router-link to="/index-3">Home slider 1</router-link></li>
									<li :class="currentPath == 'index-4' ? 'active' : 'notactive'"><router-link to="/index-4">Home slider 2</router-link></li>
								</ul>
						</li>
						<li class="has-submenu" :class="doctorMenu ? 'active' : 'notactive'">
							...
							<ul class="submenu">
								...
								<li  class="subdrop-menu" v-if="currentPath != 'patient-profile'" :class="currentPath == 'doctor-blogs' || currentPath == 'blog-details' || currentPath == 'add-blog'  ? 'has-submenu active' : 'has-submenu notactive'">
									 <a href="#">Blog</a> 
									<!-- <router-link to="/doctor/blogs">Blog</router-link> -->
									<ul class="submenu">
										<li :class="currentPath == 'doctor-blogs' ? 'active' : 'notactive'"><router-link to="/doctor/blogs">Blog</router-link></li>
							...
							<ul class="submenu" >
								...
								<li class="has-submenu" :class="pharmacyMenu ? 'active' : 'notactive'"  v-if="currentPath != 'index-1' && currentPath != 'index-2' && currentPath != 'index-3' && currentPath != 'patient-dashboard' && currentPath != 'favourites'">
						...
						<li class="has-submenu" :class="pagesMenu ? 'active' : 'notactive'">
							<a href="#">Pages <i class="fas fa-chevron-down"></i></a>
								...
								<li :class="currentPath == 'patient-register' ||  currentPath == 'doctor-register' ? 'active' : 'notactive'"><router-link to="/patient/register">Register</router-link></li>
...
export default {
    ...
    computed: {
        ...
        homeMenu() {
           return this.$route.name == 'index' || this.$route.name == 'index-1' ||  this.$route.name == 'index-2' ||  this.$route.name == 'index-3' ||  this.$route.name == 'index-4';
        },
        doctorMenu() {
           return this.$route.name == 'doctor-index' || this.$route.name == 'doctor-appointments' || this.$route.name == 'schedule-timings' ||  this.$route.name == 'my-patients' ||  this.$route.name == 'messages' ||  this.$route.name == 'invoices' ||  this.$route.name == 'profile-settings' ||  this.$route.name == 'doctor-reviews' ||  this.$route.name == 'doctor-register' ||  this.$route.name == 'doctor-blogs' ||  this.$route.name == 'blog-details' ||  this.$route.name == 'add-blog' ||  this.$route.name == 'add-prescription' ||  this.$route.name == 'edit-prescription' ||  this.$route.name == 'add-billing' ||  this.$route.name == 'edit-billing';
		},
		blogMenu() {
		...
		pharmacyMenu() {
            return this.$route.name == 'pharmacy' || this.$route.name == 'pharmacy-details' || this.$route.name == 'pharmacy-search' || this.$route.name == 'pharmacy-product' ||  this.$route.name == 'pharmacy-product-description' ||  this.$route.name == 'pharmacy-cart' ||  this.$route.name == 'pharmacy-product-checkout' ||  this.$route.name == 'patient-dashboard' ||  this.$route.name == 'favourites'  ||  this.$route.name == 'pharmacy-payment-success';
        },
    }
}
</script>