<template>
	<!-- Home Banner -->
		<section class="section section-search" v-if="currentpath == 'index' || currentpath == 'index-page'">
				...
				<div class="banner-wrapper">
					...
					<div class="search-box">
						<form>
							...
							<button @click="searchPath" class="btn btn-primary search-btn mt-0"><i class="fas fa-search"></i> <span>Search</span></button>
						</form>
					</div>
					<!-- /Search -->
				</div>
		...
		<section id="home" class="divider" v-else-if="currentpath == 'index-4'">
			<div class="pharmacy-home-slider slider" >
			...
			<section class="section-search-pharmacy" v-else-if="currentpath == 'pharmacy'">
			<div class="container-fluid">
						...
						<div class="banner-wrapper2">
							<div class="search-box1">
								<form>
									...
									<button @click="searchPath" class="btn btn-primary search-btn"><i class="fas fa-search"></i> <span>Search</span></button>
								</form>
							</div>
							<!-- /Search -->
